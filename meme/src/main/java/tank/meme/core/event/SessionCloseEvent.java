 ...
 * @version :1.0
 */
public final class SessionCloseEvent extends ApplicationEvent {
	...
	public SessionCloseEvent(Object source) {
		super(source);
	}

	public SessionCloseEvent(Object source, SocketSession session) {
		super(source);
